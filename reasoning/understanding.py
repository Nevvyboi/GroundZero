...
class WordEmbeddings:
    ...
    def build_embeddings(self) -> None:
        ...
        print(f"✅ Built word embeddings: {len(self.word_vectors)} words, {self.dimension}D")
...
class UnderstandingEngine:
    ...
    def build_understanding(self) -> None:
        ...
        print("🧠 Building understanding model...")
        ...
        if self.knowledge_chunks:
            ...
            print(f"✅ Built {valid_count}/{len(self.knowledge_chunks)} valid chunk embeddings")
        
        print(f"✅ Concept network: {len(self.concept_network.concepts)} concepts")
